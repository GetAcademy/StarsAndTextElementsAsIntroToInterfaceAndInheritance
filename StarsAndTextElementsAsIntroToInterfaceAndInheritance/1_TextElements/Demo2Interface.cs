using StarsAndTextElementsAsIntroToInterfaceAndInheritance._1_TextElements._2_WithInterface;
...
namespace StarsAndTextElementsAsIntroToInterfaceAndInheritance._1_TextElements
{
    internal class Demo2Interface
    {
        public static void Run()
        {
            ...
            var textElements = new ITextElement[] { header, bulletPoint1, paragraph, invertedText, rightAlignedText };
